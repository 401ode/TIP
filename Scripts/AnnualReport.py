...
df = pd.merge(munis, df0, how='right', on='TIPID');
df.to_csv(r'C:\Users\Nicholas.Tomlin\Documents\GitHub\TIP\CSVs By Year\FY16.csv', index=False);

df17 = pd.read_sql("SELECT * FROM FY17", conn);
bg17 = pd.read_sql("SELECT * FROM FY17_BG", conn);
df1 = pd.concat([df17, bg17]);
df = pd.merge(munis, df1, how='right', on='TIPID');
df.to_csv(r'C:\Users\Nicholas.Tomlin\Documents\GitHub\TIP\CSVs By Year\FY17.csv', index=False);
...
df = pd.merge(munis, df2, how='right', on='TIPID');
df.to_csv(r'C:\Users\Nicholas.Tomlin\Documents\GitHub\TIP\CSVs By Year\FY18.csv', index=False);

df19 = pd.read_sql("SELECT * FROM FY19", conn);
bg19 = pd.read_sql("SELECT * FROM FY19_BG", conn);
df3 = pd.concat([df19, bg19]);
df = pd.merge(munis, df3, how='right', on='TIPID');
df.to_csv(r'C:\Users\Nicholas.Tomlin\Documents\GitHub\TIP\CSVs By Year\FY19.csv', index=False);

df20 = pd.read_sql("SELECT * FROM FY20", conn);
bg20 = pd.read_sql("SELECT * FROM FY20_BG", conn);
df4 = pd.concat([df20, bg20]);
df = pd.merge(munis, df4, how='right', on='TIPID');
df.to_csv(r'C:\Users\Nicholas.Tomlin\Documents\GitHub\TIP\CSVs By Year\FY20.csv', index=False);
...
df = pd.merge(munis, df5, how='right', on='TIPID');
df.to_csv(r'C:\Users\Nicholas.Tomlin\Documents\GitHub\TIP\CSVs By Year\FY21-25.csv', index=False);
